...
export default function ThemeCalendar(props){
    ...
    const themeArray = props.themeArray;
    // || [ 
    //     {
    //         name: "Theme Array Not Found", 
    ...
    //                   id: 1,
    //                   name: 'Mentors',
    //                   description: 'An exploration of intergenerational relationships between people who support one another in work and life. Featuring the voices of those in farming, politics, education, and more. Special sections: Pets, Camp & Kids',
    //                   month: 'January',
    //                   year: 2023,
    //                 },
    //                 tags: [
